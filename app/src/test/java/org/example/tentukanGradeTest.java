...
public class tentukanGradeTest {
    ...
    void testTC02_GradeA() {
        String result = penilaian.tentukanGrade(90);
    ...
    void testTC03_GradeB() {
        String result = penilaian.tentukanGrade(75);
    ...
    void testTC04_GradeC() {
        String result = penilaian.tentukanGrade(60);
    ...
    void testTC05_GradeD() {
        String result = penilaian.tentukanGrade(45);
    ...
    void testTC06_GradeE() {
        String result = penilaian.tentukanGrade(25);
